 ...
 */
exports.setSessionInfo = function (pre_auth_code, apps) {
  const { accessToken } = await this.ensureSuiteAccessToken();
 ...
 */
exports._getPermanentCode = async function (authCode) {
  const { accessToken } = await this.ensureSuiteAccessToken();
...
exports.getCorpAccessToken = async function (authCorpId, permanentCode) {
  ...
  var url = this.prefix + 'service/get_corp_token?suite_access_token=' + accessToken;
  var data = {
    suite_id: this.suiteId,
    auth_corpid: authCorpId,
    permanent_code: permanentCode
