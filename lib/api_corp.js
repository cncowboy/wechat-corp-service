 ...
 */
exports.getDepartmentUsers = function (corpId, departmentId, fetchChild, status, callback) {
  var token = this.getCorpAccessToken(corpId);
 ...
 * @param {Number} status 0获取全部员工，1获取已关注成员列表，2获取禁用成员列表，4获取未关注成员列表。status可叠加
 */
exports.getDepartmentUsersDetail = function (corpId, departmentId, fetchChild, status, callback) {
  var token = this.getCorpAccessToken(corpId);
