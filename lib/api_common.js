...
SuiteAccessToken.prototype.isValid = () => {
  return !!this.suite_access_token && Date.now() < this.expires_in;
}
/**
...
var API = function (suiteId, suiteSecret, suiteTicket, getToken, saveToken) {
  ...
  this.getToken = getToken || function (callback) {
    if (this.store && this.store.isValid) {
...
API.prototype.requestQ = Q.bind(API.prototype.request, API.prototype);
